...
<body data-type="index" nav="nav-index">
...
<div class="am-g tpl-g">
            ...
            <div class="am-fr tpl-header-navbar">
                <ul>
                    ...
                    <li class="am-text-sm tpl-header-navbar-welcome">
                        <a href="javascript:;">欢迎您,<span>管理员[admin]</span> </a>
                    </li>
    ...
    <div class="left-sidebar">
        ...
        <ul class="sidebar-nav">
             ...
             <@shiro.hasPermission name="admin:good">
            <li class="sidebar-nav-link" active="nav-index">
            ...
            <li class="sidebar-nav-link" active="nav-member">
             ...
             <@shiro.hasPermission name="admin:information">
        ...
        <div class="row-content am-cf">
            <div class="row am-cf">
                <div class="am-u-sm-12 am-u-md-12">
                    <div class="widget am-cf" style="padding: 0px;">
                        <img src="/img/Welcome.jpg" width="100%" style="border-radius: 2px;"/>
                    </div>
                </div>
            </div>
        </div>
